from prompt_utils import LM_generation, count_tokens, toPrompt_task2
import pandas as pd
import numpy as np
import tqdm
import json
...
def QA_count_tokens(args):
    ...
    for i in tqdm(range(len(data))):
        d = data[i]
        x = toPrompt_task2(d['item_a_name'], d['assertion'], d['options'], mode = args.mode)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--QA_path", default="./data/QA_task2/QA_fullInfo.jsonl", type=str, required=False, help="path to QA_fullInfo")
    ...
    parser.add_argument("--out_dir", default="./data/QA_task2_out/QA_promptResult", type=str, required=False, help="Output dir")
